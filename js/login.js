...
function login() {
  ...
  for (i = 0; i < fields.length; i++) {
    ...
    if (document.getElementById(fields[i]).value == "") {
      ...
      document.getElementById(fields[i]).style.borderBottom = "2px solid red";
      document.getElementById('userLbl').focus();
...
function showUserInfo() {
  ...
  document.getElementById("img_avatar").innerHTML = avatar;
